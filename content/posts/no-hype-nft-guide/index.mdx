...
- “The Merge” is the most expensive NFT ever sold for $92 million
- Bored Apes and CryptoPunks NFT collections are worth $3.6 billion

NFTs have been around only for a few years, but they created a market with billions of dollars in transactions.

![Award Dance](./notion_dashboard.png)
...
Market hype and FOMO on NFTs are slowly winding down. As when the dust settles, the vision becomes clear. Industries such as arts, music, video games, sports, movies, luxury products, and many others are finding new ways of using NFTs for growing business. On the consumer side, people are looking for more pragmatic applications of NFTs than being speculative. NFTs are now gaining mainstream adoption. 

Let us deep dive into few important aspects of NFTs in this article. 

### What are NFTs?

NFTs stand for non-fungible tokens. A dollar is fungible because you can trade your dollar for another dollar.Non-fungible means it is unique, one-of-a-kind, and you cannot replace one for another. Think of the Mona Lisa painting, only one in the world.

NFTs use blockchain technology to ensure authenticity with unique, identifiable signatures. NFTs represent provable ownership of their underlying asset. If you own digital art as NFT, people can still take a screenshot and use it, but they cannot prove ownership because you are the ultimate owner of that art. NFTs examples are art, virtual avatars, GIFs, videos, trading cards, memes, domain names, in-game items, real estate, aged wines & whisky, and so on.

### Characteristics of NFTs

NFTs mainly derive their value based on scarcity, utility, and provenance. The following characteristics make them valuable.

- **Unique:** NFTs are unique (one-of-a-kind) and can be provable and verified on a blockchain.
- **Programmable:** NFTs have programmable code called smart contracts that execute on a blockchain automatically on certain conditions. Example: Smart contract in an NFT art can automatically earn royalty for the creator every time its traded. Programmability of royalties is very popular among creators as it enables them to make recurring income.
- **Composable:** NFTs are used as a paywall to restrict access to content. Its called token gating and allows content creators to monetize their content using NFTs. Token gating is just one example of how NFTs are used to compose other properties like authentication for content. Similarly, it is possible to create multiple other properties with NFTs.
- **Permissionless:** You never need any permission to create or own NFTs. Many NFTs exist on a permissionless blockchain like Ethereum or Solana. These blockchains are open for anyone to join and maintained by communities for anyone to contribute
- **Permanent:** Data of NFTs such as account address, message, image, music, and signature are stored in immutable blocks of a blockchain. NFT data are immutable and permanent
- **Digital Ownership:** NFT holders ultimately own and control the underlying content or asset of the NFT. Social media platforms like Facebook and YouTube own videos or photos you post in them. These platforms have complete ownership to your content and monetize on them. However, by holding your content as NFTs you truly own and can monetize your content
